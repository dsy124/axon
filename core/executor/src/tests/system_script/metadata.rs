use std::{sync::Arc, collections::BTreeMap, str::FromStr};

use common_config_parser::types::ConfigRocksDB;
use ethers::abi::AbiEncode;
use protocol::types::{MemoryBackend, H160, SignedTransaction, U256};
...
fn prepare_metadata() -> Metadata {
    Metadata {
        version:                    MetadataVersion { start: 1u64, end: 100u64 },
        epoch:                      0,
        gas_limit:                  1u64,
        gas_price:                  0u64,
        interval:                   0u64,
